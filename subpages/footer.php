...
<footer class="footer pb-0 pb-2">
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-7 t_footer">
                ...
                <div>
                    ...
                    <button class="btn btn-warning text-white fw-semibold">
                        <i class="fa-solid fa-headset me-2"></i> Talk To An Expert
                    </button>
                </div>
            </div>
            ...
            <div class="col-md-5  mt-4 mt-md-0">
                <div class="news_letter">
                    ...
                    <p class="para mb-3">
                        Don’t miss out! Join our community and<br>get the latest updates
                    </p>
                    <form class="footer-form d-flex justify-content-md-end">
                        <input type="email" placeholder="Enter your email" class="form-control shadow">
                        <button class="btc">Join →</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="row  text-md-start footer-links">
            ...
            <!-- Logo + Socials -->
            <div class="col-lg-3 mb-4 mb-md-0 hexa col-md-4">
                <h4 class="footer-logo">
                    <a href="#">
                        <img src="assets/img/logo.png" alt="Hexraa Logo" width="150">
                    </a>
                </h4>
            ...
            <!-- Hosting & Domain -->
            <div class="col-lg-2 text_postion col-md-4">
                <h6>HOSTING & DOMAIN</h6>
                <ul>
                    <li><a href="#">Shared Hosting</a></li>
                    <li><a href="#">Reseller Hosting</a></li>
                    <li><a href="#">Student Hosting</a></li>
            ...
            <div class="col-lg-3  col-md-4">
                ...
                <div class="payment-icons">
                    ...
                    <img src="assets/img/home/net.png">
